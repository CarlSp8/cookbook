        ...
        with gr.Blocks(theme=gr.themes.Soft()) as error_interface:
            gr.Markdown(
                ...
                <div style='text-align: center; padding: 20px;'>
                    ...
                    <p style='font-size: 1.2em;'>Please set the <code>{KEY_NAME}</code> environment variable to use this demo.</p>
                </div>
                """
            )
            ...
            with gr.TabItem("Voice Chat"):
                gr.HTML(
                    ...
                    <div style='text-align: center; margin-bottom: 1rem'>
                        <h1 style='font-size: 2em; margin-bottom: 0.5rem'>Gemini API Voice Chat</h1>
                        <p style='opacity: 0.8'>Click "Record" to start a real-time voice conversation.</p>
                    </div>
                    """
                )
