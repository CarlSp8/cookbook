...
with gr.Blocks() as demo:
    gr.HTML(
        ...
        <div style='text-align: center'>
            ...
            <p>Get a <a href="https://support.google.com/googleapi/answer/6158862?hl=en" target="_blank" rel="noopener noreferrer">Google Cloud API Key</a></p>
        </div>
    """
    )
    with gr.Row() as api_key_row:
        api_key = gr.Textbox(
            ...
            type="password",
            info="Need a Google Cloud API Key to use this demo",
        )
    with gr.Row(visible=False) as row:
        with gr.Column():
            ...
            voice = gr.Dropdown(
                ...
                value="Puck",
                info="Select a voice persona for the AI",
            )
    webrtc.stream(
        GeminiHandler(),
