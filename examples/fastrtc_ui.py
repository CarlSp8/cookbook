...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    gr.HTML(
        ...
        <div style='text-align: center'>
            ...
            <p>Get an API Key <a href="https://aistudio.google.com/apikey" target="_blank" rel="noopener noreferrer">here</a></p>
        </div>
    """
    )
    with gr.Row() as api_key_row:
        api_key = gr.Textbox(
            label="API Key",
            info="Get a free key from Google AI Studio",
    ...
    with gr.Row(visible=False) as row:
        with gr.Column():
            ...
            voice = gr.Dropdown(
                label="Voice",
                info="Choose a voice persona for the AI",
                choices=[
                    "Puck",
                    "Charon",
                    "Kore",
