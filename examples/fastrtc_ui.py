...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    gr.HTML(
        ...
        <div style='text-align: center'>
            ...
            <p>Get an API Key from <a href="https://support.google.com/googleapi/answer/6158862?hl=en" target="_blank" rel="noopener noreferrer">Google Support</a></p>
        </div>
    """
    )
    with gr.Row() as api_key_row:
        api_key = gr.Textbox(
            ...
            type="password",
            info="Your API Key will be used for this session only.",
        )
