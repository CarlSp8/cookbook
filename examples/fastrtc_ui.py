...
with gr.Blocks() as demo:
    gr.HTML(
        ...
        <div style='text-align: center'>
            ...
            <p>Get an API Key <a href="https://support.google.com/googleapi/answer/6158862?hl=en" target="_blank" rel="noopener noreferrer" aria-label="here (opens in a new tab)">here</a></p>
        </div>
    """
    )
